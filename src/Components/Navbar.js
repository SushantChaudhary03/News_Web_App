        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <div className='flex cursor-pointer group text-white'>
                <button className='btn '>Dropdown</button>
                <svg className="mt-2  w-2.5 h-2.5 ml-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                  <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
                </svg>
                <div className='dropdown group-hover:block hidden absolute mt-6  bg-slate-400 w-32 h-52 rounded-lg -ml-5'>
                  <ul className=''>
                    <li className='my-1 hover:bg-slate-600 hover:border-l hover:text-white  mx-1'>
                      <Link to="/business" className=" py-2 pl-3 pr-4 ">Business</Link>
                    </li>
                    <li className='my-1 hover:bg-slate-600 hover:border-l hover:text-white mx-1'>
                      <Link to="/entertainment" className=" py-2 pl-3 pr-4 ">Entertainment</Link>
                    </li>
                    <li className='my-1 hover:bg-slate-600 hover:border-l hover:text-white mx-1'>
                      <Link to="/general" className=" py-2 pl-3 pr-4">General</Link>
                    </li>
                    <li className='my-1 hover:bg-slate-600 hover:border-l hover:text-white mx-1'>
                      <Link to="/health" className=" py-2 pl-3 pr-4">Helth</Link>
                    </li>
                    <li className='my-1 hover:bg-slate-600 hover:border-l hover:text-white mx-1'>
                      <Link to="/science" className=" py-2 pl-3 pr-4 ">Science</Link>
                    </li>
                    <li className='my-1 hover:bg-slate-600 hover:border-l hover:text-white mx-1'>
                      <Link to="/sports" className=" py-2 pl-3 pr-4 ">Sports</Link>
                    </li>
                    <li className='my-1 hover:bg-slate-600 hover:border-l hover:text-white mx-1'>
                      <Link to="/technology" className=" py-2 pl-3 pr-4">Technology</Link>
                    </li>
                  </ul>
                </div>
              </div>
